...
require File.dirname(__FILE__) + "/merb-cache-keys_spec"
require File.dirname(__FILE__) + "/merb-cache-fragment_spec"
require File.dirname(__FILE__) + "/merb-cache-action_spec"
require File.dirname(__FILE__) + "/merb-cache-action-params_spec"
require File.dirname(__FILE__) + "/merb-cache-page_spec"
require File.dirname(__FILE__) + "/merb-cache-page-params_spec"
